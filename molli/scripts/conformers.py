...
#May not be applicable for every method
# parser.add_argument(
#     "--n_confs",
#     "-n",
#     action="store",
...
def molli_main(args, config=None, output=None, **kwargs):
    ...
    raise NotImplementedError(f'No conformer generation methods currently implemented')

    #Have not implemented methods, but provides outline for how this would work
